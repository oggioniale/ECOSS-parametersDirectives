...
The first use case is designed for policy maker or reaserchers that want to assess the contribution of a monitoring site (e.g. [Long Term Ecological Research (eLTER)](https://www.lter-europe.net/lter-europe)) to the Marine Strategy Framework Directive (MSFD).
